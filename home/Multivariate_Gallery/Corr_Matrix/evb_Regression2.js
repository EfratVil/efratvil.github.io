...
//================= Read file & create SVG =====================
   ...
   // console.log(data[0]);
    ...
    console.log("--------------------");
    console.log(d3.extent(data, function (d) { return d[asset1]; }));
    console.log([d3.min(data, function (d) { return d[asset2]; }), d3.max(data, function (d) { return d[asset2]; })]);
    ...
    .on("mouseover", function (d) {
        tooltip.transition()
            .duration(500)
            .style("opacity", .9);
        tooltip.html("X - " + d[asset1] + "<br/>Y - " + d[asset2])
